...
lib = ctypes.CDLL('/home/suraj5323/SRX/m1/codes/code.so')
...
# Input parameters
x0 = math.radians(45)  # Initial value of x
y0 = math.radians(45)  # Initial value of y
h = 0.01  # Step size
...
for i in range(n):
    x_n = x_point[-1] + h
    y_n = math.radians(90)- x_n #  formula
    x_point.append(x_n)
    y_point.append(y_n)
